...
class MyChatbot():
    ...
    def __init__(self):
        self.system_prompt = 'You are a helpful assistant in cloud devops.' \
        ' Answer questions about cloud devops, provide advice, and assist ' \
        'with troubleshooting problems as best you can.'
